...
# ======================================================================
# Script profesional para configurar el directorio .gh-bins como PATH en Termux
# Autor: cmbrdevmx
# Versión: 1.0.0
# ======================================================================
...
REPO_URL="https://github.com/CmbRDevMx/Github_Manager_CLI.git"
GH_DIR="$HOME/.gh-bins"
...
clone_repository() {
    print_message "step" "Clonando repositorio Github_Manager_CLI"
